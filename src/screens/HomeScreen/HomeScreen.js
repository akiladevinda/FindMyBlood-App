...
export default class HomeScreen extends Component {
  ...
  clickEventListener = value => {
    if (value.id == 1) {
      this.props.navigation.navigate('AddNewDoner', {
        screen: AddNewDoner,
      ...
      this.props.navigation.navigate('AddRequests', {
        screen: AddRequests,
        onGoBack: () => this.refreshScreen(),
      });
    } else if (value.id == 6) {
      ...
      this.props.navigation.navigate('ViewDoners', {
        screen: ViewDoners,
        onGoBack: () => this.refreshScreen(),
      });
            ...
            <LinearGradient
              ...
              <View style={styles.headerInfo}>
                <Text style={styles.headerInfoText}>
                  {this.state.doners_count} New Doners
                </Text>
                <View style={styles.headerInfoButtonConrainer}>
                  <TouchableOpacity
                    style={styles.headerInfoButton}
                    onPress={() => this.clickEventListener('doners')}>
              ...
              <View style={styles.headerInfo}>
                <Text style={styles.headerInfoText}>
                  {this.state.requests_count} New Requests
                </Text>
                <View style={styles.headerInfoButtonConrainer}>
                  <TouchableOpacity
                    style={styles.headerInfoButton}
                    onPress={() => this.clickEventListener('requests')}>
                    <Text style={styles.headerInforButtonText}>VIEW ALL</Text>
                  </TouchableOpacity>
                </View>
              </View>
              ...
              <View style={styles.emeregencyReqContainer}>
                <TouchableOpacity
                  style={styles.emergencyReqButton}
                  onPress={() => this.clickEventListener('addemer')}>
                  <Text style={styles.emeergenctBtnText}>
              ...
              <View style={styles.emeregencyReqContainer}>
                <TouchableOpacity
                  style={styles.emergencyReqButton}
                  onPress={() => this.clickEventListener('blood-bank')}>
                  <Text style={styles.emeergenctBtnText}>
                    National Blood Blank WebSite
                  </Text>
                </TouchableOpacity>
              </View>
              ...
              <View style={styles.emeregencyReqContainer}>
                <TouchableOpacity
                  style={styles.emergencyReqButton}
                  onPress={() =>
                    Linking.openURL('https://www.facebook.com/nbts.srilanka/')
                  }>
                  <Text style={styles.emeergenctBtnText}>
                    Official Facebook
                  </Text>
