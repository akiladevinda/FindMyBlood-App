...
export default class ViewUsersMore extends Component {
  constructor(props) {
    super(props);
    this.state = {
      user_fullname: this.props.navigation.state.params.User.Full_Name,
      mobile_number: this.props.navigation.state.params.User.Mobile_Number,
      email: this.props.navigation.state.params.User.Email,
      dob: this.props.navigation.state.params.User.DOB,
  ...
  render() {
    return (
      <View style={styles.container}>
        <HeaderPrimary
          title={this.state.user_fullname}
        ...
        <ScrollView>
          ...
          <View style={styles.borderSeparater} />
          ...
          <View style={styles.bottonCotainer}>
            <TouchableOpacity
              onPress={() => this.contactUser('email')}
              style={styles.buttonContainer}>
