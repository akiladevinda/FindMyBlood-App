...
import ViewUsersMore from './ViewUsersMore';
...
export default class ViewUsers extends Component {
    ...
    clickEventListener = (item) => {
        ...
        this.props.navigation.navigate("ViewUsersMore",{screen:ViewUsersMore,User:item})
    }
            ...
            <FlatList 
                ...
                return (
                    ...
                    <View style={styles.cardContent}>
                        ...
                        <Text style={styles.date}>Location : {item.Address}</Text>
...
const styles = StyleSheet.create({
    ...
    tasks:{
      ...
      card:{
        ...
        flexWrap: 'wrap',
        borderLeftWidth:10,
        height:Metrics.DEVICE_HEIGHT/5.2,
        borderRadius:25
      },
