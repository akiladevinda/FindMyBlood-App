...
import VeiwDonersMore from './ViewDonersMore';

export default class ViewDoners extends Component {
    ...
    clickEventListener = (item) => {
        this.props.navigation.navigate("VeiwDonersMore",{screen:VeiwDonersMore,Doners:item})
    }
            ...
            <FlatList 
                ...
                return (
                    ...
                    <View style={styles.cardContent}>
                        ...
                        <Text style={styles.date}>Blood Group : {item.Blood_Group}</Text>
